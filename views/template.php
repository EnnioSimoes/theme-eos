...
<head>
    <title>EOS Theme - The best Responsive App Landing Page</title>
    ...
    <?= $view->render('head') ?>
    <!--favicon-->
    <link rel="shortcut icon" href="<?= $view->url()->getStatic('/packages/pagekit/theme-eos/img/favicon.ico') ?>" type="image/x-icon">
    <link rel="icon" href="<?= $view->url()->getStatic('/packages/pagekit/theme-eos/img/favicon.ico') ?>" type="image/x-icon">

    <!-- Stylesheets -->


    <?php $view->style('bootstrap', 'theme:libs/bootstrap/css/bootstrap.min.css') ?>
    <?php $view->style('ionicons', 'theme:libs/ionicons/css/ionicons.min.css') ?>

    <?php $view->style('owl-carousel', 'theme:css/owl.carousel.css') ?>
    <?php $view->style('owl-theme', 'theme:css/owl.theme.css') ?>

    <?php $view->style('nivo-lightbox', 'theme:css/nivo-lightbox/nivo-lightbox.css') ?>
    <?php $view->style('nivo-lightbox-theme', 'theme:css/nivo-lightbox/nivo-lightbox-theme.css') ?>

    <?php $view->style('animate', 'theme:css/animate.css') ?>
    <?php $view->style('style', 'theme:css/style.css') ?>

    <?php $view->style('color-dark', 'theme:css/colors/dark.css') ?>
    ...
    <?php $view->script('modernizr', 'theme:js/modernizr.custom.js') ?>
...
<header class="sticky" id="header">
    <div class="container">
        <div class="row" id="logo_menu">
            <div class="col-xs-6"><a class="logo" href="">E O S</a></div>
        ...
        <div class="row">
            ...
            <div class="col-md-6 hidden-xs hidden-sm">
                <div class="hand-container">
                    <img class="iphone-hand img_res wow animated bounceInUp" data-wow-duration="1.2s" src="<?=$view->url()->getStatic('/packages/pagekit/theme-eos/img/iphone_hand.png'); ?>" alt="Iphone Hand">
...
//var_dump($view->url()->getStatic());
//echo $view->url()->getStatic('img/iphone_hand.png');
//die();
        ...
        <div class="row">
            <div class="col-sm-offset-2 col-sm-8 wow animated bounceInUp">
                ...
                <p class="text-center italic">
                    <strong>Use Lucy – the Best Responsive App Landing Page to embed your game’s or app’s review videos.</strong>
                </p>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-4 col-sm-pull-4 text-center">
                <div class="animation-box wow bounceIn animated">
                    <img class="highlight-left wow animated" src="<?= $view->url()->getStatic('/packages/pagekit/theme-eos/img/spark.png') ?>" height="192" width="48" alt="">
                    <img class="highlight-right wow animated" src="<?= $view->url()->getStatic('/packages/pagekit/theme-eos/img/spark.png') ?>" height="192" width="48" alt="">
                    <img class="screen" src="<?= $view->url()->getStatic('/packages/pagekit/theme-eos/img/features_screen.png') ?>" alt="" height="581" width="300">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-sm-6 wow fadeInLeft animated">
                <div class="phone-image">
                    <img class="img-responsive" src="<?= $view->url()->getStatic('/packages/pagekit/theme-eos/img/2-iphone-left.png') ?>" alt="">
                </div>
            </div><!--/col-sm-6-->
...
<section id="features-right-image" class="block">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm-6 wow fadeInRight animated">
                <div class="phone-image">
                    <img class="img-responsive" src="<?= $view->url()->getStatic('/packages/pagekit/theme-eos/img/2-iphone-right.png') ?>" alt="">
                </div>
            </div><!--/col-sm-6-->
        </div><!--/row-->
        ...
        <div class="row">
            <div class="col-xs-12">
                <div id="screenshots" class="owl-carousel owl-theme">
                    <a href="<?= $view->url()->getStatic('/packages/pagekit/theme-eos/img/screenshots/1.jpg') ?>" class="item" data-lightbox-gallery="screenshots">
                        <img src="<?= $view->url()->getStatic('/packages/pagekit/theme-eos/img/screenshots/1.jpg') ?>" class="img_res wow animated zoomIn" alt="">
                    </a>
                    <a href="<?= $view->url()->getStatic('/packages/pagekit/theme-eos/img/screenshots/2.jpg') ?>" class="item" data-lightbox-gallery="screenshots">
                        <img src="<?= $view->url()->getStatic('/packages/pagekit/theme-eos/img/screenshots/2.jpg') ?>" class="img_res wow animated zoomIn" alt="">
                    </a>
                    <a href="<?= $view->url()->getStatic('/packages/pagekit/theme-eos/img/screenshots/3.jpg') ?>" class="item" data-lightbox-gallery="screenshots">
                        <img src="<?= $view->url()->getStatic('/packages/pagekit/theme-eos/img/screenshots/3.jpg') ?>" class="img_res wow animated zoomIn" alt="">
                    </a>
                    <a href="<?= $view->url()->getStatic('/packages/pagekit/theme-eos/img/screenshots/4.jpg') ?>" class="item" data-lightbox-gallery="screenshots">
                        <img src="<?= $view->url()->getStatic('/packages/pagekit/theme-eos/img/screenshots/4.jpg') ?>" class="img_res wow animated zoomIn" alt="">
                    </a>
                    <a href="<?= $view->url()->getStatic('/packages/pagekit/theme-eos/img/screenshots/1.jpg') ?>" class="item" data-lightbox-gallery="screenshots">
                        <img src="<?= $view->url()->getStatic('/packages/pagekit/theme-eos/img/screenshots/1.jpg') ?>" class="img_res wow animated zoomIn" alt="">
                    </a>
            ...
            <div class="item">
                <div class="row">
                    <div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
                        <div class="client-pic"><img class="img_res" src="<?= $view->url()->getStatic('/packages/pagekit/theme-eos/img/client-two.png') ?>" alt=""></div>
                        <p class="review-star">
                            <i class="ion-star"></i>
                            <i class="ion-star"></i>
                            <i class="ion-star"></i>
            ...
            <div class="item">
                <div class="row">
                    <div class="col-sm-6 col-md-offset-3">
                        <div class="client-pic"><img class="img_res" src="<?= $view->url()->getStatic('/packages/pagekit/theme-eos/img/client-three.png') ?>" alt=""></div>
                        <p class="review-star">
                            <i class="ion-star"></i>
                            <i class="ion-star"></i>
                            <i class="ion-star"></i>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-3 col-sm-4 col-md-offset-1point5">
                <div class="team-member wow animated fadeIn" data-wow-delay="0.3s">
                    <div class="border-img">
                        <img src="<?= $view->url()->getStatic('/packages/pagekit/theme-eos/img/dev-2.jpg') ?>" class="img_res team-pic" alt="">
            ...
            <div class="col-md-3 col-sm-4">
                <div class="team-member wow animated fadeIn" data-wow-delay="0.3s">
                    <div class="border-img">
                        <img src="<?= $view->url()->getStatic('/packages/pagekit/theme-eos/img/dev-3.jpg') ?>" class="img_res team-pic" alt="">
                        <div class="border"></div>
                    </div>
            ...
            <div class="col-md-3 col-sm-4">
                <div class="team-member wow animated fadeIn" data-wow-delay="0.3s">
                    <div class="border-img">
                        <img src="<?= $view->url()->getStatic('/packages/pagekit/theme-eos/img/dev-4.jpg') ?>" class="img_res team-pic" alt="">
                        <div class="border"></div>
                    </div>
                    <h2 class="wow animated fadeInDown" data-wow-delay="0.7s">Jhon Doe</h2>
                    <p class="wow animated fadeIn" data-wow-delay="0.7s">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
...
<?php $view->script('jquery-js', 'theme:js/jquery-v1.11.1.min.js') ?>
<?php $view->script('bootstrap-js', 'theme:libs/bootstrap/js/bootstrap.min.js') ?>
<?php $view->script('wow-min-js', 'theme:js/wow.min.js') ?>
<?php $view->script('owl-carousel-js', 'theme:js/owl.carousel.js') ?>
<?php $view->script('nivo-lightbox-js', 'theme:js/nivo-lightbox.min.js') ?>
<?php $view->script('smoothscroll-js', 'theme:js/smoothscroll.js') ?>
<?php $view->script('ajaxchimp-js', 'theme:js/jquery.ajaxchimp.min.js') ?>
<?php $view->script('script-js', 'theme:js/script.js') ?>
